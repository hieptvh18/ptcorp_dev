...
class WardUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'code' => 'required|string|unique:common_wards,name,' . $this->item . ',id,deleted_at,NULL|regex:/^[a-zA-Z0-9_]+$/',
            'name' => 'required|string|unique:common_wards,name,' . $this->item . ',id,deleted_at,NULL',
